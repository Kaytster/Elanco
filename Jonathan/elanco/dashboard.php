        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    $(".text-primary").text(dogData.D_Date); // Update date
                    ...
                    setProgress("breathingRateProgress", "breathingRateText", dogData.Breath_Rate, 50, " br/min");
                    setProgress("calorieBurnProgress", "calorieBurnText", dogData.Calorie_Burnt, 500, " kcal");
                    ...
                    $(".text-warning").text("Behaviour ID: " + dogData.Behaviour_ID); // Assuming it's an ID
                    $(".text-danger").text("Barking: " + dogData.Frequency_ID); // Assuming this represents barking frequency
                } else {
