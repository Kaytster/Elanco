...
<body>
    ...
    <div class="pet-card-container">
        <?php
        $pets = [
            ["name" => "Snoopy", "age" => 13, "type" => "Maltese", "image" => "maltese dog.jpg", "page" => "dashboard.php", "weight" => "7.8 kg", "health" => "Good"],
            ["name" => "Charlie", "age" => 3, "type" => "Beagle", "image" => "beagle dog.jpg", "page" => "dashboard.php", "weight" => "11 kg", "health" => "Excellent"],
            ["name" => "Teddy", "age" => 8, "type" => "Bulldog", "image" => "bulldog dog.jpg", "page" => "dashboard.php", "weight" => "25 kg", "health" => "Good"]
        ];
