	...
	try {
		...
		$dogName = $db->query('SELECT Dog_Name FROM Dog WHERE Dog_Name= "Dog_Name" LIMIT 1');
		$rowName = $dogName->fetchArray(SQLITE3_ASSOC); // Get the data
				...
				<div class="grid">
					...
					<div class="card">
						<div class="card-body">
							...
							<p class="card-value"><?php echo $rowName['Dog_Name'] ?></p>
						</div>
					</div>
					<div class="card">
						<div class="card-body">
